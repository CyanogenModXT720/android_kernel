 ...
 * @(#) sl@belcarra.com/whiskey.enposte.net|otg/platform/otglib/otg-dev.c|20071005060910|45085
 *
...
int otg_dev_probe (struct device *device, struct otg_device_driver *otg_device_driver, void *privdata)
{
        ...
        TRACE_MSG0(otg_dev->DEV, "CALLING otg_create()");
        ...
        TRACE_MSG0(otg_dev->DEV, "REQUESTING RESOURCES");
        ...
        TRACE_MSG0(otg_dev->DEV, "PROBING");
        ...
        TRACE_MSG0(otg_dev->DEV, "STARTING");
...
void otg_dev_remove (struct device *device , struct otg_device_driver *otg_device_driver)
{
        ...
        TRACE_MSG0(otg_dev->DEV, "CALLING otg_exit()");
        otg_exit(otg);

        /* release interrupts */
        TRACE_MSG0(otg_dev->DEV, "CALLING otg_free_irgs()");
        ...
        for (i = 0; i < OTG_DRIVER_TYPES; i++) {
                ...
                switch (driver->id) {
                case OTG_DRIVER_TCD: 
                        TRACE_MSG0(otg_dev->DEV, "CALLING otg_set_tcd_ops(NULL)");
                        otg_dev->tcd_instance = otg_set_tcd_ops(otg_dev->otg_instance, NULL); 
                        break;
                case OTG_DRIVER_PCD: 
                        TRACE_MSG0(otg_dev->DEV, "CALLING otg_set_pcd_ops(NULL)");
                        otg_dev->pcd_instance = otg_set_pcd_ops(otg_dev->otg_instance, NULL); 
                        break;
                case OTG_DRIVER_HCD: 
                        TRACE_MSG0(otg_dev->DEV, "CALLING otg_set_hcd_ops(NULL)");
                        otg_dev->hcd_instance = otg_set_hcd_ops(otg_dev->otg_instance, NULL); 
                        break;
                case OTG_DRIVER_OCD: 
                        TRACE_MSG0(otg_dev->DEV, "CALLING otg_set_ocd_ops(NULL)");
        ...
        TRACE_MSG0(otg_dev->DEV, "CALLING otg_destroy()");
        otg_destroy(otg);
