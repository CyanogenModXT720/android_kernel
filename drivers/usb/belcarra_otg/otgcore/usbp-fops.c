 ...
 * @(#) sl@belcarra.com/whiskey.enposte.net|otg/otgcore/usbp-fops.c|20071005060910|53331
 *
...
void usbp_alloc_simple_configuration_descriptor(struct usbd_simple_instance *simple_instance, int cfg_size, int hs)
{
        ...
        configuration_descriptor->bMaxPower = bus->bMaxPower;
...
{
        struct usbd_bus_instance *bus = function ? function->bus : NULL;
        RETURN_UNLESS(bus);
