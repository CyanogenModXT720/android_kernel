...
wait_queue_head_t otg_switch_queue;
static u16 otg_switch_to_mode = 0;

unsigned short otg_set_func_vid = 0;
unsigned short otg_set_func_pid = 0;
unsigned char  otg_usb_mode_cdrom = 0;
...
int otg_message_ioctl_internal(unsigned int cmd, unsigned long arg)
{
        ...
        case _IOC_WRITE:
                ...
                case _IOC_NR(OTGADMIN_SET_FUNCTION):
                        ...
                        /*otg_set_func_vid = admin_command.vid;
                        otg_set_func_pid = admin_command.pid;*/
                        //otg_usb_mode_cdrom = admin_command.cdrom;
...
unsigned short otg_message_cfg_vid(void)
{
       return otg_set_func_vid;
}

unsigned short otg_message_cfg_pid(void)
{
       return otg_set_func_pid;
}
unsigned char otg_message_cfg_cdrom(void)
{
       return otg_usb_mode_cdrom;
}
OTG_EXPORT_SYMBOL(otg_message_cfg_cdrom);
