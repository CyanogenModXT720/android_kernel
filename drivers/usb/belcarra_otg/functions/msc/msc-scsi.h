 ...
 * @(#) tt/root@belcarra.com/debian286.bbb|otg/functions/msc/msc-scsi.h|20071020014806|58175
 *
...
/* CD-ROM/DVD device request READ TABLE OF CONTENTS command */
...
/*! @struct msc_scsi_read_toc_command msc-scsi.h "otg/functions/msc/msc-scsi.h"
 *
 *  @brief msc_scsi_read_toc_command wrapper
 * MODE SENSE
 */
struct msc_scsi_read_toc_command {
        u8   OperationCode;
        u8   Reserved1:6,
             MSF:1,
             Reserved2:1;
...
/*! @struct msc_scsi_read_toc_data msc-scsi.h "otg/functions/msc/msc-scsi.h"
 *
 *  @brief msc_scsi_read_toc_data wrapper
 * MODE SENSE
 */
struct msc_scsi_read_toc_data {
        u16  TOCDataLength;
        u8   FirstCSN;
        u8   LastCSN;
        struct {
                ...
                u8  FTNInLastCSN;
                u8  Reserved3;
                u32 LBAOfFTNInLastCS;
        } __attribute__((packed)) toc_track_descriptor;
        u8   Reserved4;
        u8   LOTrackIsData;
        u8   LOTrackNumber;
        u8   Reserved5;
        u32  LBAOfLTNInLastCS;
} __attribute__((packed));
...
/*! @struct msc_mode_parameter_header msc-scsi.h "otg/functions/msc/msc-scsi.h"
 *
 *  @brief  MODE PARAMETER HEADER 10
 */
struct msc_mode_parameter_header_10 {
        u16  ModeDataLength;
        u8   MediumTypeCode;
        u8   Reserved1:4,
             DPOFUA:1,
...
/*!  @struct msc_caching_page msc-scsi.h "otg/functions/msc/msc-scsi.h"
 *
 *  @brief  TIMER AND PROTECT PAGE
 *  C.f. Table 122 sbc3r11
 */
 struct msc_caching_page {
        u8   PageCode:6,
             Reserved1:1,
             PS:1;
        u8   PageLength;
        u8   IC:1,
             ...
             MF:1,
             RCD:1;
        u8   ReadRetentionPriority:4,
             WriteRetentionPriority:4;
        u16  PreFetchTransferLength;
        u16  MinimumPreFetch;
        u16  MaximumPreFetch;
        u16  MaximumPreFetchCeiling;
        u8   FSW:1,
             LBCSS:1,
             DRA:1,
             Vendor:2,
...
struct msc_mode_all_pages {
        ...
        struct msc_caching_page                                CachingPage;
} __attribute__((packed));
