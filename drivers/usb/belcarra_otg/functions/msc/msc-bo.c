...
#define MAX_HS_EP_SIZE         (PAGE_SIZE*8)
...
static struct usbd_endpoint_request msc_if_endpoint_requests[ENDPOINTS+1] = {
        { BULK_OUT, 1, 0, 0, USB_DIR_OUT | USB_ENDPOINT_BULK, PAGE_SIZE, MAX_HS_EP_SIZE, 0, },
        { BULK_IN, 1, 0, 0, USB_DIR_IN | USB_ENDPOINT_BULK, PAGE_SIZE, MAX_HS_EP_SIZE, 0, },
        { 0, },
};
...
static struct usbd_alternate_description msc_data_alternate_descriptions[] = {
        {
                .iInterface = "Motorola Mass Storage Interface",
