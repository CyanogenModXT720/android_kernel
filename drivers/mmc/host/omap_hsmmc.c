...
#ifdef CONFIG_PM
static int omap_mmc_clk_enable(struct mmc_omap_host *host)
{
	unsigned long flags;
	int ret = 0;
...
static void omap_mmc_clk_disable(struct mmc_omap_host *host)
{
	unsigned long flags;
...
#else
#define omap_mmc_clk_enable	NULL
#define omap_mmc_clk_disable	NULL
#endif
