...
typedef enum {
    BD7885_STROBE_OFF = 0,
    BD7885_STROBE_QUENCH_MODE,
    BD7885_STROBE_MANUAL_MODE,
} bd7885_strobe_mode;
*/
...
#define BD7885_IOCTL_SET_AF_LED _IOW(BD7885_IOCTL_BASE, 7, unsigned char)
		/*on/off control for AF LED.*/
...
#define BD7885_IOCTL_FIRE_STROBE_MANUAL \
		_IOW(BD7885_IOCTL_BASE, 9, unsigned char)
