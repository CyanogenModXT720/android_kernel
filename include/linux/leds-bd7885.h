...
#define BD7885_IOCTL_GET_REGISTER                   _IOR(BD7885_IOCTL_BASE, 0, bd7885_cfg) /*Register value read out from Xenon flash module.*/
#define BD7885_IOCTL_SET_REGISTER                    _IOW(BD7885_IOCTL_BASE, 1, bd7885_cfg) /*Register value write down to Xenon flash module.*/
#define BD7885_IOCTL_SET_CHARGING                   _IOW(BD7885_IOCTL_BASE, 2, unsigned char) /*Set charging status.*/

#define BD7885_IOCTL_SET_CHARG_LEVEL             _IOW(BD7885_IOCTL_BASE,3, unsigned char)  /*Set FULLADJ value for charging.*/
#define BD7885_IOCTL_SET_QUENCH_MODE           _IOW(BD7885_IOCTL_BASE, 4, unsigned char) /*Off (no quench), On (with quench).*/
#define BD7885_IOCTL_SET_QUENCH_THRESHOLD _IOW(BD7885_IOCTL_BASE, 5, unsigned char) /*Sets VSTOPADJ parameter.*/
#define BD7885_IOCTL_GET_STATUS                       _IOR(BD7885_IOCTL_BASE, 6, unsigned char) /*Charged status get.*/

#define BD7885_IOCTL_SET_AF_LED                      _IOW(BD7885_IOCTL_BASE, 7, unsigned char) /*on/off control for AF LED.*/
#define BD7885_IOCTL_READY_STROBE_MANUAL     _IOW(BD7885_IOCTL_BASE, 8, unsigned char) /* test ready strobe manually.*/
#define BD7885_IOCTL_FIRE_STROBE_MANUAL     _IOW(BD7885_IOCTL_BASE, 9, unsigned char) /* test fire strobe manually.*/
